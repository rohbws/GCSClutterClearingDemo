...
class IiwaHardwareStationDiagram(Diagram):
    ...
    def getBuilder(self):
        return self.builderAll
    
    def get_external_plant(self) -> MultibodyPlant:
        return self._external_station.GetSubsystemByName("plant")
